...
import { createUserCompanyRequest, fetchUserCompanyRequests } from "../../api/user.api";
import { useAuth } from "../../composables/useAuth";
import { usePreferences } from "../../composables/usePreferences";
import { useToast } from "../../composables/useToast";
import type { CompanyPreference, CompanyRequest, TableColumn } from "../../types";
import { formatDate } from "../../utils/format";
import { toggleStringValue } from "../../utils/forms";
...
async function load(): Promise<void> {
  ...
  error.value = null;
  try {
    const [companiesPayload, requestsPayload] = await Promise.all([fetchCatalogCompanies(), fetchUserCompanyRequests()]);
...
function toggleCompany(companyName: string): void {
  draft.value.preferred_companies = toggleStringValue(draft.value.preferred_companies, companyName);
}
